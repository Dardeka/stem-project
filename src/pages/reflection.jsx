...
function Reflection() {
    return(
        <>
            <Header/>
            <main>
                <section className="flex flex-col items-center justify-center w-full h-[550px] bg-[url('/images/reflection.jpeg')] bg-[length:100%_100%] bg-cover bg-center bg-no-repeat">
